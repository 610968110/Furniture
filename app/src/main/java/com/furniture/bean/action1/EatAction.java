...
public class EatAction extends ActionBean implements IModeAction {

    public static final String NAME = "Dining";

    public EatAction(Context context, String room, String deviceName) {
    ...
    public EatAction(Context context, String room, String deviceName, ActionClick task) {
        super("用餐", room, deviceName, R.drawable.icon_scene_eat, R.drawable.icon_scene_eat_s, task);
    }
