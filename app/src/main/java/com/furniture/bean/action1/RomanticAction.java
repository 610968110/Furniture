...
public class RomanticAction extends ActionBean implements IModeAction {

    public static final String NAME = "Dining";

    public RomanticAction(Context context, String room, String deviceName) {
    ...
    public RomanticAction(Context context, String room, String deviceName, ActionClick task) {
        super("浪漫", room, deviceName, R.drawable.icon_scene_eat, R.drawable.icon_scene_eat_s, task);
    }
