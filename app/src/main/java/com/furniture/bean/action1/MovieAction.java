...
public class MovieAction extends ActionBean implements IModeAction {

    public static final String NAME = "Viewing";

    public MovieAction(Context context, String room, String deviceName) {
    ...
    public MovieAction(Context context, String room, String deviceName, ActionClick task) {
        super("观影", room, deviceName, R.drawable.icon_scene_movie, R.drawable.icon_scene_movie_s, task);
    }
