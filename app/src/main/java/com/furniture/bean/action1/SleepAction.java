...
public class SleepAction extends ActionBean implements IModeAction {

    public static final String NAME = "Meeting";

    public SleepAction(Context context, String room, String deviceName) {
    ...
    public SleepAction(Context context, String room, String deviceName, ActionClick task) {
        super("睡眠", room,deviceName, R.drawable.icon_scene_meet, R.drawable.icon_scene_meet_s, task);
    }
