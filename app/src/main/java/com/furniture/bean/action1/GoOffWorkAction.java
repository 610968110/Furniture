...
public class GoOffWorkAction extends ActionBean implements IModeAction {

    public static final String NAME = "Meeting";

    public GoOffWorkAction(Context context, String room, String deviceName) {
    ...
    public GoOffWorkAction(Context context, String room, String deviceName, ActionClick task) {
        super("下班", room,deviceName, R.drawable.icon_scene_meet, R.drawable.icon_scene_meet_s, task);
    }
