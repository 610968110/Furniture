...
public class ReadAction extends ActionBean implements IModeAction {

    public static final String NAME = "Reading";

    public ReadAction(Context context, String room, String deviceName) {
    ...
    public ReadAction(Context context, String room, String deviceName,ActionClick task) {
        super("阅读", room, deviceName, R.drawable.icon_scene_read, R.drawable.icon_scene_read_s, task);
    }
