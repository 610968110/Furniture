...
public class NoAction extends ActionBean implements IModeAction {

    public static final String NAME = "Dining";

    public NoAction(Context context, String room, String deviceName) {
    ...
    public NoAction(Context context, String room, String deviceName, ActionClick task) {
        super("无模式", room, deviceName, R.drawable.icon_scene_eat, R.drawable.icon_scene_eat_s, task);
    }
