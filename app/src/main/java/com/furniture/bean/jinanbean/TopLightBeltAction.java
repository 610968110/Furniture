...
public class TopLightBeltAction extends ActionBean {

    public static final String ID = "";

    public TopLightBeltAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "天花灯带");
                onClick(context, isLongClick);
            }
        });
    }

    public TopLightBeltAction(Context context, String room, String deviceName, ActionClick task) {
        super("天花灯带", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
