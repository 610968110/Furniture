...
public class TopLightAction extends ActionBean {

    public static final String ID = "";

    public TopLightAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "天花筒灯");
                onClick(context, isLongClick);
            }
        });
    }

    public TopLightAction(Context context, String room, String deviceName, ActionClick task) {
        super("天花筒灯", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
