...
public class TVWallLightBeltAction extends ActionBean {

    public static final String ID = "";

    public TVWallLightBeltAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "电视墙灯带");
                onClick(context, isLongClick);
            }
        });
    }

    public TVWallLightBeltAction(Context context, String room, String deviceName, ActionClick task) {
        super("电视墙灯带", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
