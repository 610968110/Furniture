...
public class KeTingMainLightAction extends ActionBean {

    public static final String ID = "";

    public KeTingMainLightAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "客主筒灯");
                onClick(context, isLongClick);
            }
        });
    }

    public KeTingMainLightAction(Context context, String room, String deviceName, ActionClick task) {
        super("客主筒灯", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
