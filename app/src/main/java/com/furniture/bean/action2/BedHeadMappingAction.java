...
public class BedHeadMappingAction extends ActionBean {

    public static final String ID = "";

    public BedHeadMappingAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "床头射灯");
                onClick(context, isLongClick);
            }
        });
    }

    public BedHeadMappingAction(Context context, String room, String deviceName, ActionClick task) {
        super("床头射灯", room, deviceName, R.drawable.icon_light_chuangtao, R.drawable.icon_light_chuangtao_s, task);
    }
