...
public class MasterRoomLightBeltAction extends ActionBean {

    public static final String ID = "";

    public MasterRoomLightBeltAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "主卧灯带");
                onClick(context, isLongClick);
            }
        });
    }

    public MasterRoomLightBeltAction(Context context, String room, String deviceName, ActionClick task) {
        super("主卧灯带", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
