...
public class DinnerRoomTopLightAction extends ActionBean {

    public static final String ID = "";

    public DinnerRoomTopLightAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "餐厅吊灯");
                onClick(context, isLongClick);
            }
        });
    }

    public DinnerRoomTopLightAction(Context context, String room, String deviceName,ActionClick task) {
        super("餐厅吊灯",  room,deviceName,R.drawable.icon_light_eat, R.drawable.icon_light_eat_s, task);
    }
