...
public class WallLightBeltAction extends ActionBean {

    public static final String ID = "";

    public WallLightBeltAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "墙面灯带");
                onClick(context, isLongClick);
            }
        });
    }

    public WallLightBeltAction(Context context, String room, String deviceName, ActionClick task) {
        super("墙面灯带", room, deviceName, R.drawable.icon_light_wall, R.drawable.icon_light_wall_s, task);
    }
