...
public class WardrobeLightBeltAction extends ActionBean {

    public static final String ID = "";

    public WardrobeLightBeltAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "衣柜灯带");
                onClick(context, isLongClick);
            }
        });
    }

    public WardrobeLightBeltAction(Context context, String room, String deviceName, ActionClick task) {
        super("衣柜灯带", room, deviceName, R.drawable.icon_light_yigui, R.drawable.icon_light_yigui_s, task);
    }
