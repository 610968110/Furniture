...
public class ParlourMappingAction extends ActionBean {

    public static final String ID = "";

    public ParlourMappingAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "客厅射灯");
                onClick(context, isLongClick);
            }
        });
    }

    public ParlourMappingAction(Context context, String room, String deviceName, ActionClick task) {
        super("客厅射灯", room, deviceName, R.drawable.icon_light_dachuang, R.drawable.icon_light_dachuang_s, task);
    }
