...
public class DoorLightAction extends ActionBean {

    public static final String ID = "";

    public DoorLightAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "门口筒灯");
                onClick(context, isLongClick);
            }
        });
    }

    public DoorLightAction(Context context, String room, String deviceName, ActionClick task) {
        super("门口筒灯", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
