...
public class BookRoomBoxLightAction extends ActionBean {

    public static final String ID = "";

    public BookRoomBoxLightAction(Context context, String room, String deviceName) {
    ...
    public BookRoomBoxLightAction(Context context, String room, String deviceName, ActionClick task) {
        super("书柜灯", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
