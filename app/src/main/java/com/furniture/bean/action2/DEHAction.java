...
public class DEHAction extends ActionBean {

    public static final String ID = "5b73c1540778b5689255a4ca";
    /**
     * 开关
     */
    public static final String NAME = "Deh1";

    private boolean tempStatue = false;

    public DEHAction(Context context, String room, String deviceName) {
    ...
    public DEHAction(Context context, String room, String deviceName, ActionClick task) {
        super("除湿器", room, deviceName, R.drawable.icon_air_hot, R.drawable.icon_air_hot_s, task);
    }
