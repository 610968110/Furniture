...
public class SofaMappingAction extends ActionBean {

    public static final String ID = "";

    public SofaMappingAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "沙发射灯");
                onClick(context, isLongClick);
            }
        });
    }

    public SofaMappingAction(Context context, String room, String deviceName, ActionClick task) {
        super("沙发射灯", room, deviceName, R.drawable.icon_light_chuangtao, R.drawable.icon_light_chuangtao_s, task);
    }
