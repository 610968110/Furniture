...
public class LeftLightAction extends ActionBean {

    public static final String ID = "";

    public LeftLightAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "左侧吊灯");
                onClick(context, isLongClick);
            }
        });
    }

    public LeftLightAction(Context context, String room, String deviceName,ActionClick task) {
        super("左侧吊灯", room, deviceName,R.drawable.icon_light_left, R.drawable.icon_light_left_s, task);
    }
