...
public class ZouDaoLightAction extends ActionBean {

    public static final String ID = "";

    public ZouDaoLightAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "走道筒灯");
                onClick(context, isLongClick);
            }
        });
    }

    public ZouDaoLightAction(Context context, String room, String deviceName, ActionClick task) {
        super("走道筒灯", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
