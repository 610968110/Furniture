...
public class DinnerRoomLeftMappingAction extends ActionBean {

    public static final String ID = "";

    public DinnerRoomLeftMappingAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "餐厅射灯(左)");
                onClick(context, isLongClick);
            }
        });
    }

    public DinnerRoomLeftMappingAction(Context context, String room, String deviceName, ActionClick task) {
        super("餐厅射灯(左)", room, deviceName, R.drawable.icon_light_eat_shoot, R.drawable.icon_light_eat_shoot_s, task);
    }
