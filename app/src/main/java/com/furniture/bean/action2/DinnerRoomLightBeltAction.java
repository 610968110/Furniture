...
public class DinnerRoomLightBeltAction extends ActionBean {

    public static final String ID = "";

    public DinnerRoomLightBeltAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "餐厅灯带");
                onClick(context, isLongClick);
            }
        });
    }

    public DinnerRoomLightBeltAction(Context context, String room, String deviceName, ActionClick task) {
        super("餐厅灯带", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
