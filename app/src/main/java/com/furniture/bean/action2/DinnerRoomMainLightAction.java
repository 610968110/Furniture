...
public class DinnerRoomMainLightAction extends ActionBean {

    public static final String ID = "";

    public DinnerRoomMainLightAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "餐厅主灯");
                onClick(context, isLongClick);
            }
        });
    }

    public DinnerRoomMainLightAction(Context context, String room, String deviceName, ActionClick task) {
        super("餐厅主灯", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
