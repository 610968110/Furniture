...
public class MasterRoomMainLightAction extends ActionBean {

    public static final String ID = "";

    public MasterRoomMainLightAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "主卧主灯");
                onClick(context, isLongClick);
            }
        });
    }

    public MasterRoomMainLightAction(Context context, String room, String deviceName, ActionClick task) {
        super("主卧主灯", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
