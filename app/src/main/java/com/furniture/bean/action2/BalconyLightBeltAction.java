...
public class BalconyLightBeltAction extends ActionBean {

    public static final String ID = "";

    public BalconyLightBeltAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "阳台灯带");
                onClick(context, isLongClick);
            }
        });
    }

    public BalconyLightBeltAction(Context context, String room,String deviceName, ActionClick task) {
        super("阳台灯带", room,deviceName, R.drawable.icon_light_yangtai, R.drawable.icon_light_yangtai_s, task);
    }
