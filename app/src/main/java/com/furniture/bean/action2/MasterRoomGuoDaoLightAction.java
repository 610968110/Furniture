...
public class MasterRoomGuoDaoLightAction extends ActionBean {

    public static final String ID = "";

    public MasterRoomGuoDaoLightAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "主卧过道灯");
                onClick(context, isLongClick);
            }
        });
    }

    public MasterRoomGuoDaoLightAction(Context context, String room, String deviceName, ActionClick task) {
        super("主卧过道灯", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
