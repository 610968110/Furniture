...
public class BookRoomLight1Action extends ActionBean {

    public static final String ID = "";

    public BookRoomLight1Action(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "书房筒灯1");
                onClick(context, isLongClick);
            }
        });
    }

    public BookRoomLight1Action(Context context, String room, String deviceName, ActionClick task) {
        super("书房筒灯1", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
