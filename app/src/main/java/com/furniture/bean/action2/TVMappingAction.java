...
public class TVMappingAction extends ActionBean {

    public static final String ID = "";

    public TVMappingAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "电视射灯");
                onClick(context, isLongClick);
            }
        });
    }

    public TVMappingAction(Context context, String room, String deviceName, ActionClick task) {
        super("电视射灯", room, deviceName, R.drawable.icon_light_tv, R.drawable.icon_light_tv_s, task);
    }
