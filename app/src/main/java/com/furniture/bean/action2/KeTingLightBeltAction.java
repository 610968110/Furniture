...
public class KeTingLightBeltAction extends ActionBean {

    public static final String ID = "";

    public KeTingLightBeltAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "客厅灯带");
                onClick(context, isLongClick);
            }
        });
    }

    public KeTingLightBeltAction(Context context, String room, String deviceName, ActionClick task) {
        super("客厅灯带", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
