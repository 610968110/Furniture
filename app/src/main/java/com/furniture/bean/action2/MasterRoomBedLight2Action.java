...
public class MasterRoomBedLight2Action extends ActionBean {

    public static final String ID = "";

    public MasterRoomBedLight2Action(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "主卧床头灯2");
                onClick(context, isLongClick);
            }
        });
    }

    public MasterRoomBedLight2Action(Context context, String room, String deviceName, ActionClick task) {
        super("主卧床头灯2", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
