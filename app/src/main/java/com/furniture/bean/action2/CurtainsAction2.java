...
public class CurtainsAction2 extends ActionBean {

    public static final String ID = "";
    public static final String NAME = "Gau1";

    public CurtainsAction2(Context context, String room, String deviceName) {
    ...
    public CurtainsAction2(Context context, String room, String deviceName, ActionClick task) {
        super("窗帘2", room, deviceName, R.drawable.icon_window_yarn, R.drawable.icon_window_yarn_s, task);
    }
