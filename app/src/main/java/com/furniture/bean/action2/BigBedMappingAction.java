...
public class BigBedMappingAction extends ActionBean {

    public static final String ID = "";

    public BigBedMappingAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "大床射灯");
                onClick(context, isLongClick);
            }
        });
    }

    public BigBedMappingAction(Context context, String room, String deviceName, ActionClick task) {
        super("大床射灯", room, deviceName, R.drawable.icon_light_dachuang, R.drawable.icon_light_dachuang_s, task);
    }
