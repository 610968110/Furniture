...
public class DinnerRoomRightMappintAction extends ActionBean {

    public static final String ID = "";

    public DinnerRoomRightMappintAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "餐厅射灯(右)");
                onClick(context, isLongClick);
            }
        });
    }

    public DinnerRoomRightMappintAction(Context context, String room,String deviceName, ActionClick task) {
        super("餐厅射灯(右)", room,deviceName, R.drawable.icon_light_eat_shoot1, R.drawable.icon_light_eat_shoot1s, task);
    }
