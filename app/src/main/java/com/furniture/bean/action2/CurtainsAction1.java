...
public class CurtainsAction1 extends ActionBean {

    public static final String ID = "";
    public static final String NAME = "Curt1";

    public CurtainsAction1(Context context, String room, String deviceName) {
    ...
    public CurtainsAction1(Context context, String room, String deviceName, ActionClick task) {
        super("窗帘1", room, deviceName, R.drawable.icon_window_curtain, R.drawable.icon_window_curtain_s, task);
    }
