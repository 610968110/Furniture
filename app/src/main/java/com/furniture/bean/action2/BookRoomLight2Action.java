...
public class BookRoomLight2Action extends ActionBean {

    public static final String ID = "";

    public BookRoomLight2Action(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "书房筒灯2");
                onClick(context, isLongClick);
            }
        });
    }

    public BookRoomLight2Action(Context context, String room, String deviceName, ActionClick task) {
        super("书房筒灯2", room, deviceName, R.drawable.icon_light_door, R.drawable.icon_light_door_s, task);
    }
