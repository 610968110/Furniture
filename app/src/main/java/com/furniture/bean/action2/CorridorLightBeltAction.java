...
public class CorridorLightBeltAction extends ActionBean {

    public static final String ID = "";

    public CorridorLightBeltAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "走廊灯带");
                onClick(context, isLongClick);
            }
        });
    }

    public CorridorLightBeltAction(Context context, String room, String deviceName, ActionClick task) {
        super("走廊灯带", room, deviceName, R.drawable.icon_light_corridor, R.drawable.icon_light_corridor_s, task);
    }
