...
public class RightLightAction extends ActionBean {

    public static final String ID = "";

    public RightLightAction(Context context, String room, String deviceName) {
        ...
        setTask(new ActionClick() {
            ...
            public void actionClick(boolean isLongClick) {
                ...
                xLogUtil.e(this, "右侧吊灯");
                onClick(context, isLongClick);
            }
        });
    }

    public RightLightAction(Context context, String room, String deviceName,ActionClick task) {
        super("右侧吊灯", room,deviceName, R.drawable.icon_light_right, R.drawable.icon_light_right_s, task);
    }
