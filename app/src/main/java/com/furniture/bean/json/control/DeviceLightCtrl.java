...
public class DeviceLightCtrl extends IGson {
     ...
     * room + devid 为控制的完整字段
     */
    public DeviceLightCtrl(String id, String room, String devid, String procode, boolean open) {
        this.id = id;
    ...
    public DeviceLightCtrl(String room, String devid, String procode, boolean open) {
