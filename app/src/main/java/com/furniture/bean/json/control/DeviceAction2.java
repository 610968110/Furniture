...
public class DeviceAction2 extends IGson {
     ...
     * room + devid 为控制的完整字段
     */
    public DeviceAction2(String id, String room, String devid, String procode, int open) {
        this.id = id;
    ...
    public DeviceAction2(String room, String devid, String procode, int open) {
    ...
    public class Params {
        ...
        public Params(String devid, String procode, int open) {
            this.devid = devid;
