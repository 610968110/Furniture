...
public class DeviceRead extends IGson {
     ...
     * room + devid 为控制的完整字段
     */
    public DeviceRead(String id, String room, String devid, String procode, boolean open) {
        this.id = id;
    ...
    public DeviceRead(String room, String devid, String procode, boolean open) {
