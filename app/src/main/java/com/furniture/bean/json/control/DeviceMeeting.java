...
public class DeviceMeeting extends IGson {
     ...
     * room + devid 为控制的完整字段
     */
    public DeviceMeeting(String id, String room, String devid, String procode, boolean open) {
        this.id = id;
    ...
    public DeviceMeeting(String room, String devid, String procode, boolean open) {
