...
public class DeviceDry extends IGson {
     ...
     * room + devid 为控制的完整字段
     */
    public DeviceDry(String id, String room, String devid, String procode, boolean open) {
        this.id = id;
    ...
    public DeviceDry(String room, String devid, String procode, boolean open) {
