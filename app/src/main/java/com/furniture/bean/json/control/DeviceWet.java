...
public class DeviceWet extends IGson {
     ...
     * room + devid 为控制的完整字段
     */
    public DeviceWet(String id, String room, String devid, String procode, boolean open) {
        this.id = id;
    ...
    public DeviceWet(String room, String devid, String procode, boolean open) {
