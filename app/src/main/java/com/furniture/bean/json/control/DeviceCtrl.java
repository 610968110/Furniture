...
public class DeviceCtrl extends IGson {
     ...
     * room + devid 为控制的完整字段
     */
    public DeviceCtrl(String id, String room, String devid, String procode, boolean open) {
        this.id = id;
    ...
    public DeviceCtrl(String room, String devid, String procode, boolean open) {
