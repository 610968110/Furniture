...
public class DeviceStuffy extends IGson {
     ...
     * room + devid 为控制的完整字段
     */
    public DeviceStuffy(String id, String room, String devid, String procode, boolean open) {
        this.id = id;
    ...
    public DeviceStuffy(String room, String devid, String procode, boolean open) {
