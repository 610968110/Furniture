...
public class DeviceHot extends IGson {
     ...
     * room + devid 为控制的完整字段
     */
    public DeviceHot(String id, String room, String devid, String procode, boolean open) {
        this.id = id;
    ...
    public DeviceHot(String room, String devid, String procode, boolean open) {
