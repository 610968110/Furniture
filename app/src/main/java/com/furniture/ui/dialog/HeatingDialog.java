 ...
 * Desc:
 */
public class HeatingDialog extends BaseActivity {
    ...
    public static XIntent getIntent(Context context, int selectTemp) {
        XIntent xIntent = new XIntent(context, HeatingDialog.class);
    ...
    public void initListener() {
        ...
        if (mSelectTemp >= 8 && mSelectTemp < 10) {
            ...
            String[] strings1 = {"0", "1", "2", "3", "4", "5", "6", "7", "8"};
            wheelView2.setItems(strings1);
        ...
        wheelView1.setOnWheelViewListener((selectedIndex, item) -> {
            if ("0".equals(item)) {
                ...
                // 2
                wheelView2.setItems("0", "1", "2", "3", "4", "5", "6", "7", "8");
                wheelView2.setSeletion(0);
                i1 = 0;
            }
