...
class JiNanXuanguanFFragment : DinnerRoomFragment() {
    override fun initAllAction(): Array<ActionBean> {
        return arrayOf( //                //新风
            ...
            SupperLight(activity, ROOM, "L1", "厨房主灯"),
            SupperLight(activity, ROOM, "L2", "厨房灯带"),
            SupperLight(activity, ROOM, "L3", "次卫镜前灯"),
            SupperLight(activity, ROOM, "L4", "次卫马桶灯"),
            SupperLight(activity, ROOM, "L5", "次卫淋浴灯"),
            //空调
