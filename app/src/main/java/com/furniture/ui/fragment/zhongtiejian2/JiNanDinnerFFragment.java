...
public class JiNanDinnerFFragment extends KeTingRoomFragment {
    ...
    public ActionBean[] initAllAction() {
        return new ActionBean[]{
                ...
                new SupperLight(getActivity(), ROOM, "L1", "玄关灯"),
                new SupperLight(getActivity(), ROOM, "L2", "射灯"),
                new SupperLight(getActivity(), ROOM, "L3", "主灯"),
                new SupperLight(getActivity(), ROOM, "L4", "灯带"),
                new SupperLight(getActivity(), ROOM, "L5", "阳台灯"),
                new SupperLight(getActivity(), ROOM, "L6", "主卫筒灯"),
                new SupperLight(getActivity(), ROOM, "L7", "主卫灯带"),
                new SupperLight(getActivity(), ROOM, "L8", "主卫排风"),
