...
public class JiNanB240Fragment extends BookRoomFragment {

    public static JiNanB240Fragment newInstance(@DrawableRes int bg) {
        Bundle args = new Bundle();
        args.putInt("bg", bg);
        JiNanB240Fragment fragment = new JiNanB240Fragment();
