...
public class JiNanB280Fragment extends BookRoomFragment {

    public static JiNanB280Fragment newInstance(@DrawableRes int bg) {
        Bundle args = new Bundle();
        args.putInt("bg", bg);
        JiNanB280Fragment fragment = new JiNanB280Fragment();
