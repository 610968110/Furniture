...
public class JiNanJiaceng40Fragment extends MasterRoomFragment {

    public static JiNanJiaceng40Fragment newInstance(@DrawableRes int bg) {
        Bundle args = new Bundle();
        args.putInt("bg", bg);
        JiNanJiaceng40Fragment fragment = new JiNanJiaceng40Fragment();
