...
public class JiNanDinner40Fragment extends KeTingRoomFragment {

    public static JiNanDinner40Fragment newInstance(@DrawableRes int bg) {
        Bundle args = new Bundle();
        args.putInt("bg", bg);
        JiNanDinner40Fragment fragment = new JiNanDinner40Fragment();
    ...
    public ActionBean[] initAllAction() {
        return new ActionBean[]{
                ...
                new SupperLight(getActivity(), ROOM, "L3", "顶面灯带"),
                new SupperLight(getActivity(), ROOM, "L4", "电视射灯"),
                new SupperLight(getActivity(), ROOM, "L5", "电视灯带"),
                new SupperLight(getActivity(), ROOM, "L6", "餐厅筒灯"),
                // 窗帘
