...
public class HLayout extends FrameLayout {
    ...
    public HLayout(@NonNull Context context) {
        this(context, null);
    }

    public HLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View view = XTools.UiUtil().inflate(R.layout.layout_h);
        addView(view);
        textView = view.findViewById(R.id.tv_temp);
        textViewT = view.findViewById(R.id.tv_h0);
        textView.setSymbol(" % ");
    }
