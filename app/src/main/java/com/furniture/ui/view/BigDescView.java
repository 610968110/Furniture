...
public class BigDescView extends FrameLayout {
    ...
    public BigDescView(@NonNull Context context) {
        this(context, null);
    }

    public BigDescView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BigDescView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View view = XTools.UiUtil().inflate(R.layout.view_big_desc);
        addView(view);
    ...
    public void setSymbolText(String text) {
        if (TextUtils.isEmpty(text)) {
            mSymbolView.setVisibility(GONE);
        } else {
