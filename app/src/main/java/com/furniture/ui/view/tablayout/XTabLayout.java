...
package com.furniture.ui.view.tablayout;
...
public class XTabLayout extends HorizontalScrollView {
    ...
    public XTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //自己的自定义属性
        mTabLineOffset = a.getDimensionPixelSize(R.styleable.TabLayout_tabLineWidth, 0);
        ...
        if (a.hasValue(com.furniture.R.styleable.TabLayout_tabTextSize)) {
            // If we have an explicit text color set, use it instead
            mTabTextSize = a.getDimensionPixelSize(com.furniture.R.styleable.TabLayout_tabTextSize, 0);
        }
    ...
    private LinearLayout.LayoutParams createLayoutParamsForTabs() {
        final LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                XTools.WindowUtil().getScreenWidth() / 5, LayoutParams.MATCH_PARENT);
        ...
        public void onMeasure(final int origWidthMeasureSpec, final int origHeightMeasureSpec) {
            ...
            if (mTextView != null) {
                ...
                if (textSize != curTextSize || (curMaxLines >= 0 && maxLines != curMaxLines)) {
                    ...
                    if (updateTextView || true) {
                        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, XTools.ResUtil().getDimen(com.furniture.R.dimen.tab_text_size));
